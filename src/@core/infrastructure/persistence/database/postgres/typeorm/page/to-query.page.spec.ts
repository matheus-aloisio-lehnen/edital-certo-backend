...
describe("toQuery", () => {
    const allowedOrderBy = [
        ...
        "prices.currency",
        "prices.value",
        "prices.discounts.key",
        "prices.discounts.value",
        "prices.discounts.campaignStartsAt"
    ];

    describe("where / splits / nested objects", () => {
        ...
        it("should support deep nesting, e.g., prices.discounts.key", () => {
            const params: PageParams = {
                offset: 0,
                limit: 10,
                orderBy: "id",
                sortOrder: sortOrder.desc,
                where: { "prices.discounts.key": "OFF10" }
            };
            const result = toQuery(params, allowedOrderBy);
            expect(result.where).toEqual({
                prices: {
    ...
    describe("operators", () => {
        ...
        it("should generate MoreThan/MoreThanOrEqual/LessThan/LessThanOrEqual for gt/gte/lt/lte", () => {
            const params: PageParams = {
                offset: 0,
                limit: 10,
                orderBy: "id",
    ...
    describe("order by", () => {
        ...
        it("should apply nested orderBy when allowed, e.g., prices.discounts.key", () => {
            const params: PageParams = {
                offset: 0,
                limit: 10,
