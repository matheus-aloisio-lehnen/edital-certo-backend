...
describe('TransactionManager', () => {
    ...
    describe('run()', () => {
        it('Scenario 1 — success: should execute transaction successfully and commit', async () => {
        ...
        it('Scenario 2 — error with AppException: should rollback and rethrow error', async () => {
        ...
        it('Scenario 3 — generic error: should rollback and throw AppException(500)', async () => {
        ...
        it('Scenario 4 — default context: should use "transaction" as context name', async () => {
        ...
        it('Scenario 5 — custom context: should use metadata.name in components', async () => {
            const fn = vi.fn().mockResolvedValue('ok');
        ...
        it('Should validate basic execution order', async () => {
        ...
        it('Ensure that tx is set in CLS before executing fn', async () => {
