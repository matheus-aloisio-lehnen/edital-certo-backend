...
export const authWinbackRequestedTemplate = (lang: string, translated: any, payload: any): string => {
    const url = `${process.env.V1_FRONTEND_URL}/auth/confirmar-reativacao?h=${payload.hash}`;
