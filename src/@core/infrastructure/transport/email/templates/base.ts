export const emailBaseTemplate = (title: string, content: string, lang: string): string => `
<!doctype html>
<html lang="${lang}">
<head>
    <meta charset="UTF-8">
    ...
    <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
            <td style="padding: 0 48px;">
                <div style="border-top: 1px solid #c1c6d7; width: 100%;"></div>
            </td>
        </tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td>
                            ...
                            <p style="margin: 4px 0 0 0;">© ${new Date().getFullYear()} — Florianópolis, SC.</p>
                        </td>
                        <td align="right" style="vertical-align: bottom;">
                            <a href="${process.env.V1_FRONTEND_URL}/suporte" style="color: #0058c9; text-decoration: none; font-weight: 600;">Suporte</a>
                        </td>
                    </tr>
                </table>
            </td>
