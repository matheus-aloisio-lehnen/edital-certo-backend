...
import type { DiscountDuration, DiscountType } from '@product/constant/discount.constant';
import type { CreateDiscountProps } from '@product/props/create-discount.props';
