...
import { authWinbackConfirmedTemplate } from "@auth/infrastructure/transport/out/email/template/auth-winback-confirmed.template";
...
export class WinbackConfirmedHandler {
    ...
    async handle(input: EventInput): Promise<void> {
        ...
        const html = authWinbackConfirmedTemplate(lang, translated, payload, frontendUrl);
