...
export const authPwdResetRequestedTemplate = (lang: string, translated: any, payload: any, frontendUrl: string): string => {
    const url = `${frontendUrl}/redefinir-senha?h=${payload.hash}`;
