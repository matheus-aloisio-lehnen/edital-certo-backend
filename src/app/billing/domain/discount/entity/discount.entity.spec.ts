...
describe('Discount', () => {
    ...
    it('constructor should create a discount successfully', () => {
    ...
    it('validate should throw error if priceId is less than 1', () => {
    ...
    it('validate should throw error if fixed value is negative', () => {
        expect(() => new Discount({ ...validDiscountProps, type: discountType.fixed, value: -1 })).toThrow(AppException);
    });

    it('constructor should create a fixed discount successfully', () => {
        const discount = new Discount({ ...validDiscountProps, type: discountType.fixed, value: 500 });
        expect(discount.value).toBe(500);
    });

    it('validate should throw error if duration is missing', () => {
    ...
    it('validate should throw error if duration is invalid', () => {
    ...
    it('validate should throw error if repeating duration missing count', () => {
    ...
    it('validate should throw error if non-repeating duration has count', () => {
    ...
    it('validate should throw error if count is negative', () => {
    ...
    it('constructor should create a repeating discount successfully', () => {
    ...
    it('validate should throw error if campaignStartsAt is missing', () => {
    ...
    it('validate should throw error if campaignEndsAt is missing', () => {
    ...
    it('validate should throw error if campaignEndsAt is before campaignStartsAt', () => {
        expect(() => new Discount({
            ...validDiscountProps,
    ...
    it('validate should throw error if externalDiscountId is empty string', () => {
        expect(() => new Discount({ ...validDiscountProps, externalDiscountId: ' ' })).toThrow(
            new AppException(code.discountExternalIdEmptyError, 400)
        );
    });

    it('linkExternalDiscountId should link external discount id', () => {
        const discount = new Discount(validDiscountProps);
    ...
    it('priceId getter should throw error if priceId is not set', () => {
